view: success_signup {
  sql_table_name: heapdata.success_signup ;;
  ...
  dimension: authorization_groups {
    type: string
    sql: ${TABLE}.authorization_groups ;;
  }
  ...
  dimension: campaign_marketing_channels {
    type: string
    sql: ${TABLE}.campaign_marketing_channels ;;
  }
  ...
  dimension: how_did_hear {
    type: string
    sql: ${TABLE}.how_did_hear ;;
  }
  ...
  dimension: specific_marketing_channels {
    type: string
    sql: ${TABLE}.specific_marketing_channels ;;
  }

  dimension: specific_marketing_channels_copy {
    type: string
    sql: ${TABLE}.specific_marketing_channels_copy ;;
  }
