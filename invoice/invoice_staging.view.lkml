view: invoice_staging {
  ...
  derived_table: {
    ...
    UNION ALL
      SELECT
          ...
          invoice_id,
          invoice_record_id,
          'Fixed Project Level Bug Fee' as source
      FROM
          invoice.fixed_project_level_bug_fee
    UNION ALL
      SELECT
          payment_date,
          contest_id,
          ...
          invoice_id,
          invoice_record_id,
          'Marathon Payments' as source
      FROM
          invoice.marathon_payments
    UNION ALL
      SELECT
          payment_date,
          contest_id,
          ...
          invoice_id,
          invoice_record_id,
          'Member Payments' as source
      FROM
          invoice.member_payments
    UNION ALL
      SELECT
          payment_date,
          contest_id,
          ...
          invoice_id,
          invoice_record_id,
          'Precentage Fee DR' as source
      FROM
          invoice.percentage_fee_dr
     UNION ALL
      SELECT
          payment_date,
          contest_id,
          ...
          invoice_id,
          invoice_record_id,
          'Precentage Fee Payment' as source
      FROM
          invoice.percentage_fee_payment
    UNION ALL
      SELECT
          payment_date,
          contest_id,
          ...
          invoice_id,
          invoice_record_id,
          'Precentage Fee Payment2' as source
      FROM
          invoice.percentage_fee_payment2
    UNION ALL
      SELECT
          payment_date,
          contest_id,
          ...
          invoice_id,
          invoice_record_id,
          'Precentage Fee Project Level Payments' as source
      FROM
          invoice.percentage_fee_project_level_payments
    UNION ALL
      SELECT
          payment_date,
          contest_id,
          ...
          invoice_id,
          invoice_record_id,
          'Project Level Payments' as source
      FROM
          invoice.project_level_payments
    UNION ALL
      SELECT
          payment_date,
          contest_id,
  ...
  measure: max_payment_date {
    description: "Max Payment Date"
    type: date
    sql: MAX(${TABLE}.payment_date) ;;
    convert_tz: no
  }
