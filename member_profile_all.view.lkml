    ...
    case: {
      ...
      when: {
        sql:  ${reporting_country} ='Armenia' or
              ...
              ${reporting_country} ='Yemen'  ;;
      label: "Western Asia"
    }
      when: {
        sql:  ${reporting_country} ='Anguilla' or
              ...
              ${reporting_country} ='Saint BarthÃ©lemy' or
      ...
      when: {
          sql:  ${reporting_country} ='Belarus' or
                ...
                ${reporting_country} ='Ã…land Islands' or
